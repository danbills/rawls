...
class launchAnalysis100 extends Simulation {
	...
	val scn = scenario("launchAnalysis100")
		.feed(tsv("100_submissions_workspaceNames.tsv")) //feed the list of 100 clones created for this test

...
libraryDependencies ++= {
  ...
  Seq(
    ...
    //"com.orientechnologies" % "orient-commons" % "1.7.10", // for some reason using this causes things to fail
    "com.tinkerpop.gremlin" % "gremlin-java" % "2.6.0",
    //"com.michaelpollmeier" %% "gremlin-scala" % "3.0.0.M7" exclude("org.slf4j", "slf4j-log4j12"),
